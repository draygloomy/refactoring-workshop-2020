                ...
                try
                {
                    ...
                    */
                    ...
                    else
                    {
                        ...
                        m_displayPort.send(std::make_unique<EventT<DisplayInd>>(foodPosition));

                        foodPosition.x = receivedFood.x;
                        foodPosition.y = receivedFood.y;
                        foodPosition.value = Cell_FOOD;
                        m_displayPort.send(std::make_unique<EventT<DisplayInd>>(foodPosition));
                    }
